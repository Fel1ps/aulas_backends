...
<div class="container">
    ...
    <form action="<?php echo isset($usuario) ? 'atualizar.php' : 'inserir.php' ?>" method="post"
    ...
    <input class="form-control" type="number" step="0.01" name="senha" id="senha" value="<?php echo $usuario['senha'] ?? ""; ?>"><br>
